...
void EventHandler::slotToggleTestRadioButton(bool v) {
    qDebug() << "Test Radiobutton tooglet " << v;
    emit signalTestRadioButtonToogled(v);
}
void EventHandler::slotToggleSpiralRadioButton(bool v)
{
    qDebug() << "Spiral Radiobutton tooglet ";
    emit signalSpiralRadioButtonToogled(v);
}
